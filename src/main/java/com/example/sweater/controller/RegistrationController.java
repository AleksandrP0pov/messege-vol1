...
public class RegistrationController {
    ...
    public String addUser(
        ...
        String url = format(CAPTCHA_URL, secret, captchaResponse);
        ...
        boolean isCofirmEmpty = StringUtils.isEmpty(passwordConfirmation);
        ...
        if (isCofirmEmpty || bindingResult.hasErrors() || !response.isSuccess()){
